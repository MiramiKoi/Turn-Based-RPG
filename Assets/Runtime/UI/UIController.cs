...
namespace Runtime.UI
{
    public class UIController : IPresenter
    {
        ...
        public UIController(World world, PlayerControls playerControls, WorldViewDescriptions viewDescriptions)
        {
            ...
            _playerInventoryPresenter = new InventoryPresenter(_playerInventoryModel, inventoryView, viewDescriptions, world, InventoryType.Player);
            ...
            _equipmentInventory = new InventoryPresenter(equipmentModel, equipmentView, viewDescriptions, world, InventoryType.Equipment);
            ...
            _trashInventoryPresenter = new InventoryPresenter(trashInventoryModel, trashInventoryView, viewDescriptions, world, InventoryType.Trash);
        }
