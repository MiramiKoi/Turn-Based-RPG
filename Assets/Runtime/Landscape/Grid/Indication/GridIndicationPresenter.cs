...
namespace Runtime.Landscape.Grid.Indication
{
    public class GridIndicationPresenter : IPresenter
    {
        ...
        {
            _cellCursorLoadModel =
                _world.AddressableModel.Load<Tile>(_worldViewDescriptions.GridIndicationViewDescription.CellCursorAsset
                    .AssetGUID);
            await _cellCursorLoadModel.LoadAwaiter;
            var cellCursorTile = _cellCursorLoadModel.Result;

            _routePointLoadModel =
                _world.AddressableModel.Load<Tile>(_worldViewDescriptions.GridIndicationViewDescription.RoutePointAsset
                    .AssetGUID);
