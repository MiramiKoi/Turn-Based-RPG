...
namespace Runtime.LoadSteps
{
    public class UnitsLoadStep : IStep
    {
        ...
        public Task Run()
        {
            ...
            (
                "bear_0",
                new Vector2Int(50, 50), _world.WorldDescription.UnitCollection["bear"], _world.WorldDescription);
            ...
            (
                "bear_1",
                new Vector2Int(48, 80), _world.WorldDescription.UnitCollection["bear"], _world.WorldDescription);
